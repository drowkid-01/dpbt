#!/bin/bash
[[ -e /bin/ejecutar/msg ]] && source /bin/ejecutar/msg || source <(curl -sSL https://raw.githubusercontent.com/drowkid-01/dpbt/main/Otros/msg)
bar="$(msg -bar3)"
...
wget -q --no-check-certificate -O $HOME/files.tar https://raw.githubusercontent.com/drowkid-01/dpbt/main/Code-BOT-Comandos/files.tar
